from one_against_all import mod_1
from nuar_without_cards import mod_2
from detective_against_thief import mod_3
...
while True:
    ...
    begin_topic = tk.Label(
        text="ДОБРО ПОЖАЛОВАТЬ В МЕНЮ!", font=("Arial, 50"), bg="#DAA520"
    )
    ...
    m_3 = tk.Button(
        ...
        height=4,
        bg="#DAA520",
        command=lambda: change_n(3),
    )
    m_4 = tk.Button(
        text="ОПИСАНИЯ РЕЖИМОВ",
        font=("Arial, 15"),
        bd=20,
        width=22,
        height=4,
        bg="green",
        command=lambda: change_n(4),
    )
    m_5 = tk.Button(
        text="ВЫЙТИ ИЗ МЕНЮ",
        font=("Arial, 15"),
